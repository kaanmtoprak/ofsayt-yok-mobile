    ...
    >
      <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: "center", padding: 16 }}>
        <View className="rounded-2xl bg-white px-4 py-5 shadow-sm">
          <Text className="text-2xl font-bold text-neutral-900">Giriş Yap</Text>
          <Text className="mt-1 text-sm text-neutral-500">Hesabına giriş yaparak devam et.</Text>
          ...
          <View className="mt-4 flex-row items-center justify-center">
            <Text className="text-sm text-neutral-500">Hesabın yok mu? </Text>
            <Link
              href={{ pathname: "/(auth)/sign-up", params: { callbackUrl: callbackUrl ?? "/(tabs)/settings" } }}
